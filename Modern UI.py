...
def build_left_menu_frame():
    ...
    if Developer_Mode == True:
        reset_database_button = customtkinter.CTkButton(left_menu_frame, text = "Reset Database", width = 300, height = 20, fg_color = "red", font = customButtonFont, corner_radius = 0, command = reset_database)
